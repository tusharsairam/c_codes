...
3. The reference solution posted in the website for Ex 5 took 1.3 seconds to run on my machine, so looks like my solution is 2-3x faster because of my choice of `rand_r()`
